...
public class TinyDB {
    ...
    public ArrayList<Drink> getListObject(String key){
        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<Drink> playerList =  new ArrayList<>();
        int index = 0;
        for(String jObjString : objStrings){
            Drink player  = gson.fromJson(jObjString,  Drink.class);
            index++;
            Log.d("Test_Print","ten "+player.getName()+" so "+ index);
    ...
    public void putListObject(String key, ArrayList<Drink> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Drink player: playerList){
